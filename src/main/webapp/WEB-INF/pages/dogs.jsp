...
<html>
		...
		<div id="primary-style">
		   <p>
			   	The dog (Canis lupus familiaris[1]) is a domesticated form of the grey/gray wolf, a member of the Canidae 
				...
				mean the male of a canine species,[2] as opposed to the word "bitch" for the female of the species.[3]
			</p>   
			<c:url var="imageUrl" value="/resources/images/Black_Dog.jpg" />
		    <img src="${imageUrl}"/>
